...
use super::{BlocklyOutput, BlockDefinition, BlockArg, ArgType, ConnectionType};
...
fn generate_blocks_typescript(output: &BlocklyOutput) -> String {
    ...
    // Header
    ts.push_str(&format!(
        "// Generated Blockly blocks for {} theory\n",
        output.theory_name
    ));
    ...
    // Export
    ts.push_str("export default Blockly.common.createBlockDefinitionsFromJsonArray(definitions);\n");
...
fn generate_categories_typescript(output: &BlocklyOutput) -> String {
    ...
    // Header
    ts.push_str(&format!(
        "// Generated category metadata for {} theory\n",
        output.theory_name
    ));
    ts.push_str("// DO NOT EDIT - generated by MeTTaIL theory! macro\n\n");
